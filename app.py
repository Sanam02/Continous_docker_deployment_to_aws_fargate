...
def hello_devops():
    ...
    <body>
        <div class="container">
            ...
            <p>Visit my GitHub repository for more information: <a href="https://github.com/your-github-username" target="_blank">GitHub Repo</a></p>
            <hr>
            <p>Follow me:</p>
            <div class="social-icons">
                ...
                <!-- Add your Twitter link above -->
            </div>
        </div>
        <footer style="text-align: center; padding: 10px; background-color: #333; color: #fff;">
            &copy; Copyright: Apache License 2.0 | Your Name | Github: Your GitHub Username
        </footer>
    </body>
    </html>
    '''
